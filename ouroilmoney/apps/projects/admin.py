...
class AnnualBudgetProjectAdmin(admin.ModelAdmin):
     fields= ['title','sector','regions','amount','town','currency','is_published']
     list_display = ('title', 'sector' ,'amount_from_annual_project','town','is_published')
     list_filter  = ('title','sector', 'town','currency','is_published')
